...
namespace fileUpload {
    ...
    public partial class fileUploadDataSet : global::System.Data.DataSet {
        ...
        public partial class UserInfoDataTable : global::System.Data.TypedTableBase<UserInfoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UserInfoRow AddUserInfoRow(string Account, string PWD) {
        ...
        public partial class UserInfoRow : global::System.Data.DataRow {
            ...
            public string Account {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("表“UserInfo”中列“Account”的值为 DBNull。", e);
                    }
                }
                set {
            ...
            public bool IsAccountNull() {
                return this.IsNull(this.tableUserInfo.AccountColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetAccountNull() {
                this[this.tableUserInfo.AccountColumn] = global::System.Convert.DBNull;
            }
...
namespace fileUpload.fileUploadDataSetTableAdapters {
    ...
    public partial class UserInfoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[UserInfo] WHERE (([ID] = @Original_ID) AND ((@IsNull_Account =" +
                " 1 AND [Account] IS NULL) OR ([Account] = @Original_Account)) AND ((@IsNull_PWD " +
                "= 1 AND [PWD] IS NULL) OR ([PWD] = @Original_PWD)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[UserInfo] ([Account], [PWD]) VALUES (@Account, @PWD);\r\nSELECT " +
                "ID, Account, PWD FROM UserInfo WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[UserInfo] SET [Account] = @Account, [PWD] = @PWD WHERE (([ID] = @Original_ID) AND ((@IsNull_Account = 1 AND [Account] IS NULL) OR ([Account] = @Original_Account)) AND ((@IsNull_PWD = 1 AND [PWD] IS NULL) OR ([PWD] = @Original_PWD)));
SELECT ID, Account, PWD FROM UserInfo WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::fileUpload.Properties.Settings.Default.fileUploadConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Account, PWD FROM dbo.UserInfo";
        ...
        public virtual int Fill(fileUploadDataSet.UserInfoDataTable dataTable) {
        ...
        public virtual fileUploadDataSet.UserInfoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            fileUploadDataSet.UserInfoDataTable dataTable = new fileUploadDataSet.UserInfoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(fileUploadDataSet.UserInfoDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(fileUploadDataSet dataSet) {
        ...
        public virtual int Delete(int Original_ID, string Original_Account, string Original_PWD) {
        ...
        public virtual int Insert(string Account, string PWD) {
            if ((Account == null)) {
        ...
        public virtual int Update(string Account, string PWD, int Original_ID, string Original_Account, string Original_PWD, int ID) {
            if ((Account == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Account, string PWD, int Original_ID, string Original_Account, string Original_PWD) {
            return this.Update(Account, PWD, Original_ID, Original_Account, Original_PWD, Original_ID);
        }
    }
